...
```bash
yarn add @apollo/client @pinia/nuxt @rollup/plugin-graphql @vue/apollo-composable @vueuse/core @vueuse/nuxt apollo-link-context apollo-upload-client dayjs graphql graphql-tag tailwindcss-aspect-ratio unplugin-icons unplugin-vue-components vite-plugin-eslint
```
